module Marpa
  class Parser
    ...
    def build_meta_grammar(actions)
      ...
      actions.create_symbol([["<lexeme rule>"]])
      actions.priority_rule([[[["statement"]]], ["::="], [[[[[[[["<start rule>"]]]]], [] of String], "|", [[[[[["<priority rule>"]]]]], [] of String], "|", [[[[[["<quantified rule>"]]]]], [] of String], "|", [[[[[["<discard rule>"]]]]], [] of String], "|", [[[[[["<empty rule>"]]]]], [] of String], "|", [[[[[["<lexeme rule>"]]]]], [] of String]]]])
      ...
      actions.create_literal(["':lexeme'"])
      actions.create_symbol([["symbol"]])
      actions.priority_rule([[[["<lexeme rule>"]]], ["::="], [[[[[["':lexeme'"]], [[[["<op declare match>"]]]], [[[["symbol"]]]], [[[["<adverb list>"]]]]], [[["action", "=>", "lexeme_rule"]]]]]]])
      ...
      actions.create_symbol([["<action specification>"]])
      ...
      actions.create_symbol([["<pause specification>"]])
      actions.create_symbol([["<event specification>"]])
      actions.priority_rule([[[["<adverb item>"]]], ["::="], [[[[[[[["<action specification>"]]]]], [] of String], "|", [[[[[["<separator specification>"]]]]], [] of String], "|", [[[[[["<proper specification>"]]]]], [] of String], "|", [[[[[["<rank specification>"]]]]], [] of String], "|", [[[[[["<pause specification>"]]]]], [] of String], "|", [[[[[["<event specification>"]]]]], [] of String]]]])
      actions.create_literal(["'action'"])
      actions.create_literal(["'=>'"])
      actions.create_symbol([["<name>"]])
      actions.priority_rule([[[["<action specification>"]]], ["::="], [[[[[["'action'"]], [["'=>'"]], [[[["<name>"]]]]], [] of String]]]])
      ...
      actions.create_literal(["'pause'"])
      actions.create_symbol([["<before or after>"]])
      actions.priority_rule([[[["<pause specification>"]]], ["::="], [[[[[["'pause'"]], [["'=>'"]], [[[["<before or after>"]]]]], [] of String]]]])
      actions.create_literal(["'event'"])
      actions.priority_rule([[[["<event specification>"]]], ["::="], [[[[[["'event'"]], [["'=>'"]], [[[["<name>"]]]]], [] of String]]]])
